        ...
        <div className="contact-wrapper">
            <div className="contact-header">
                <div className="contact-head-left">
                    <h2>Contact Us.</h2>
                    <p>Questions about renting a home, buying or selling a home, or hiring a property manager?</p>
                    <br />
                    <p>Don't hesistate to reach out to us. Whether we work together or simply provide you with information, we would be delighted to hear from you.</p>
                </div>
