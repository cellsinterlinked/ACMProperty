    ...
    return(
        <div className="package-wrapper">
            ...
            <div className="package-intro">
                ...
                <p>Designed for investors who want to avoid involvement with their rental properties, the premium package completely removes the rental owner from managing their investments.</p>
