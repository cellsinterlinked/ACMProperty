      ...
      children={
        <>
          <p className="included-text">
            A routine periodic inspection is completed every six months from the
            start of the lease. If it is warrented, a periodic inspection ouside
            of the 6-month schedule can occur.
          </p>
        </>
      }
    />
